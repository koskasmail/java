...
* [01.first program](#first_program)
* [02.package](#package)
* [03.class](#class)
* [04.`main` method](#main_method)
* [05.System.out.println](#System-out-println)
* [06.package, class, method](#package-class-method)
...
#### ✏️ example: a statement (1 line of code)
```
System.out.println("Hello World");
```

#### ✏️ example: 2 statements (2 line of code)
```
System.out.println("Hello World");
